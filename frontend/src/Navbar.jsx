  ...
  return (
    <nav style={{borderBottom:'1px solid #1e1e2e', backdropFilter:'blur(12px)'}}
      ...
      <div className="flex items-center gap-2.5 min-w-[140px]">
        <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-blue-500/25">
          F
        </div>
            ...
            <Link
              ...
              className={`flex items-center gap-2.5 px-5 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                active
                  ...
                  : 'text-[#6a6a8a] hover:text-white hover:bg-white/5'
              }`}
            >
